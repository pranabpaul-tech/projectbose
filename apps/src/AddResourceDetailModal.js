...
export class AddResourceDetailModal extends Component{
    constructor(props){
        super(props);
    ...
    handleSubmit(event){
        ...
        const requestOptions = {
            method: 'POST',
            body: JSON.stringify({resourcedetailid: event.target.ResourceDetailId.value,
        ...
        fetch(process.env.REACT_APP_API+'Resourcedetails', requestOptions)
